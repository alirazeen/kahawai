...
const Phase* Phase::MULTIPLEX_IFRAME_BEGIN = new Phase("MULTIPLEX_IFRAME_BEGIN");
const Phase* Phase::MULTIPLEX_IFRAME_RECEIVED = new Phase("MULTIPLEX_IFRAME_RECEIVED");
const Phase* Phase::MULTIPLEX_IFRAME_END = new Phase("MULTIPLEX_IFRAME_END");

const Phase* Phase::MULTIPLEX_PFRAME_BEGIN = new Phase("MULTIPLEX_PFRAME_BEGIN");
