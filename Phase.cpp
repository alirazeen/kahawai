...
const Phase* Phase::IFRAME_MULTIPLEX_IFRAME_BEGIN = new Phase("IFRAME_MULTIPLEX_IFRAME_BEGIN");
const Phase* Phase::IFRAME_MULTIPLEX_IFRAME_END = new Phase("IFRAME_MULTIPLEX_IFRAME_END");
